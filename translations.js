(() => {
  ...
  // Phase 3 uses the same dictionary and explicit language-change event.
  entries.push(
["ENTREPRENØR-AKADEMIET","CONTRACTOR ACADEMY","BAUUNTERNEHMER-AKADEMIE","AKADEMIA WYKONAWCY"],
["Officielt uofficielle kvalifikationer.","Officially unofficial qualifications.","Offiziell inoffizielle Qualifikationen.","Oficjalnie nieoficjalne kwalifikacje."],
["HULSPECIALIST","HOLE SPECIALIST","LOCHSPEZIALIST","SPECJALISTA OD DZIUR"],
["Du har beregnet dit første hul.","You calculated your first hole.","Du hast dein erstes Loch berechnet.","Obliczyłeś swoją pierwszą dziurę."],
["DET KAN ALTID BLIVE STØRRE","IT CAN ALWAYS GET BIGGER","GRÖSSER GEHT IMMER","ZAWSZE MOŻE BYĆ WIĘKSZE"],
["Fornuft blev fravalgt til fordel for kubikmeter.","Common sense lost to cubic metres.","Vernunft musste Kubikmetern weichen.","Rozsądek przegrał z metrami sześciennymi."],
["UNDSKYLDNINGSMESTER","EXCUSE MASTER","AUSREDENMEISTER","MISTRZ WYMÓWEK"],
["Du er nu kvalificeret til mandagsmødet.","You now qualify for the Monday meeting.","Du bist jetzt fürs Montagsmeeting qualifiziert.","Masz już kwalifikacje na poniedziałkowe zebranie."],
["Planlægning er nu officielt valgfrit.","Planning is now officially optional.","Planung ist jetzt offiziell freiwillig.","Planowanie jest teraz oficjalnie opcjonalne."],
["AKUT GODKENDT","EMERGENCY APPROVED","NOTFALLGEPRÜFT","ZATWIERDZONY AWARYJNIE"],
["Gravemaskinen er følelsesmæssigt på vej.","The excavator is emotionally on its way.","Der Bagger ist gefühlsmäßig unterwegs.","Koparka jest emocjonalnie w drodze."],
["PEPSI MAX-ANSVARLIG","PEPSI MAX MANAGER","PEPSI-MAX-BEAUFTRAGTER","KIEROWNIK PEPSI MAX"],
["Hydrering? Nej. Arbejdsstrategi.","Hydration? No. Work strategy.","Flüssigkeitszufuhr? Nein. Arbeitsstrategie.","Nawodnienie? Nie. Strategia pracy."],
["🔒 LÅST","🔒 LOCKED","🔒 GESPERRT","🔒 ZABLOKOWANE"],
["✓ OPNÅET","✓ EARNED","✓ ERREICHT","✓ ZDOBYTE"],
["🏆 ACHIEVEMENT UNLOCKED","🏆 ACHIEVEMENT UNLOCKED","🏆 ERFOLG FREIGESCHALTET","🏆 OSIĄGNIĘCIE ODBLOKOWANE"],
["Brug hulberegneren · større hul ×3 · ny undskyldning ×3 · quiz mindst 80 % · gennemfør akut-hjælp · Pepsi ×5. Nulstilles ved genindlæsning.","Use the hole calculator · bigger hole ×3 · new excuse ×3 · quiz at least 80% · finish emergency help · Pepsi ×5. Resets on reload.","Lochrechner nutzen · größeres Loch ×3 · neue Ausrede ×3 · Quiz mindestens 80 % · Notfallhilfe abschließen · Pepsi ×5. Neustart beim Neuladen.","Użyj kalkulatora dziur · większa dziura ×3 · nowa wymówka ×3 · quiz minimum 80% · ukończ pomoc awaryjną · Pepsi ×5. Reset po odświeżeniu."],
["REGNEAFDELINGEN GÆTTER","THE ACCOUNTS TEAM IS GUESSING","DIE BUCHHALTUNG RÄT","KSIĘGOWOŚĆ ZGADUJE"],
["FÅ ET HELT UFORPLIGTENDE CIRKA-TILBUD","GET A COMPLETELY NON-BINDING ROUGH QUOTE","HOL DIR EIN VÖLLIG UNVERBINDLICHES UNGEFÄHR-ANGEBOT","OTRZYMAJ CAŁKOWICIE NIEZOBOWIĄZUJĄCĄ WYCENĘ NA OKO"],
["Prisen er vejledende. Meget vejledende.","The price is indicative. Very indicative.","Der Preis ist ein Richtwert. Ein sehr grober.","Cena jest orientacyjna. Bardzo orientacyjna."],
["HVAD SKAL DER LAVES?","WHAT NEEDS DOING?","WAS SOLL GEMACHT WERDEN?","CO TRZEBA ZROBIĆ?"],
["Et hul","A hole","Ein Loch","Dziura"],
["Et stort hul","A big hole","Ein großes Loch","Duża dziura"],
["Noget med jord","Something with soil","Irgendwas mit Erde","Coś z ziemią"],
["Noget kunden ikke helt kan forklare","Something the customer cannot quite explain","Etwas, das der Kunde nicht ganz erklären kann","Coś, czego klient nie umie wyjaśnić"],
["HVOR HASTER DET?","HOW URGENT IS IT?","WIE DRINGEND IST ES?","JAK BARDZO SIĘ SPIESZY?"],
["Ikke så meget","Not very","Nicht besonders","Niezbyt"],
["I denne uge","This week","Diese Woche","W tym tygodniu"],
["I går","Yesterday","Gestern","Wczoraj"],
["Kunden står allerede og kigger","The customer is already watching","Der Kunde steht schon daneben","Klient już stoi i patrzy"],
["HVOR MEGET PEPSI MAX ER TILGÆNGELIGT?","HOW MUCH PEPSI MAX IS AVAILABLE?","WIE VIEL PEPSI MAX IST VORHANDEN?","ILE PEPSI MAX JEST DOSTĘPNE?"],
["Ingen","None","Keins","Brak"],
["1 dåse","1 can","1 Dose","1 puszka"],
["En kasse","A case","Eine Kiste","Zgrzewka"],
["Professionelle mængder","Professional quantities","Professionelle Mengen","Profesjonalne ilości"],
["BEREGN CIRKA-PRIS","CALCULATE ROUGH PRICE","UNGEFÄHREN PREIS BERECHNEN","OBLICZ CENĘ NA OKO"],
["ESTIMERET PRIS","ESTIMATED PRICE","GESCHÄTZTER PREIS","SZACOWANA CENA"],
["Usikkerhed","Uncertainty","Unsicherheit","Niepewność"],
["Forventet arbejdstid","Expected work time","Erwartete Arbeitszeit","Przewidywany czas pracy"],
["Risikoniveau","Risk level","Risikostufe","Poziom ryzyka"],
["Pepsi Max-tillæg","Pepsi Max surcharge","Pepsi-Max-Zuschlag","Dopłata za Pepsi Max"],
["PRØV EN DÅRLIGERE BEREGNING","TRY A WORSE CALCULATION","SCHLECHTERE BERECHNUNG VERSUCHEN","SPRÓBUJ GORSZEGO OBLICZENIA"],
["Dette er selvfølgelig ikke et rigtigt tilbud.","This is obviously not a real quote.","Das ist natürlich kein echtes Angebot.","To oczywiście nie jest prawdziwa oferta."],
["Vi skulle helst have været færdige i går.","We should ideally have finished yesterday.","Am besten wären wir gestern fertig gewesen.","Najlepiej byłoby skończyć wczoraj."],
["Et sted mellem 45 minutter og torsdag.","Somewhere between 45 minutes and Thursday.","Irgendwo zwischen 45 Minuten und Donnerstag.","Gdzieś między 45 minutami a czwartkiem."],
["Højt. Naboen er allerede nervøs.","High. The neighbour is already nervous.","Hoch. Der Nachbar ist schon nervös.","Wysoki. Sąsiad już się denerwuje."],
["Moderat, men stigende.","Moderate, but rising.","Mäßig, aber steigend.","Umiarkowany, ale rośnie."],
["kunden har styr på prioriteterne.","the customer has their priorities straight.","der Kunde hat die Prioritäten im Griff.","klient zna swoje priorytety."],
["strategisk forsyning mangler.","strategic supplies are missing.","strategischer Nachschub fehlt.","brakuje strategicznych zapasów."],
["BEVISMATERIALE","EVIDENCE","BEWEISMATERIAL","MATERIAŁ DOWODOWY"],
["DOKUMENTATION","DOCUMENTATION","DOKUMENTATION","DOKUMENTACJA"],
["Fordi billeder før arbejdet gør forklaringen bagefter meget lettere.","Because photos before the work make explaining it afterwards much easier.","Weil Fotos vor der Arbeit die Erklärung danach viel leichter machen.","Bo zdjęcia przed pracą znacznie ułatwiają późniejsze wyjaśnienia."],
["FØR","BEFORE","VORHER","PRZED"],
["EFTER","AFTER","NACHHER","PO"],
["VIS EFTER","SHOW AFTER","NACHHER ZEIGEN","POKAŻ PO"],
["VIS FØR","SHOW BEFORE","VORHER ZEIGEN","POKAŻ PRZED"],
["Pæn græsplæne","Nice lawn","Schöner Rasen","Ładny trawnik"],
["Potentiale","Potential","Potenzial","Potencjał"],
["Lille bunke jord","Small pile of soil","Kleiner Erdhaufen","Mała kupka ziemi"],
["Geografisk landemærke","Geographical landmark","Geografische Landmarke","Geograficzny punkt orientacyjny"],
["Kunden: Bare lige lidt","Customer: Just a little","Kunde: Nur ein bisschen","Klient: Tylko troszkę"],
["Projektet har udviklet sig","The project has evolved","Das Projekt hat sich entwickelt","Projekt się rozwinął"],
["BOOST-NIVEAU","BOOST LEVEL","BOOST-STUFE","POZIOM DOŁADOWANIA"],
["Tryk på dåserne i Live Status. +20 % pr. klik. Maks. 200 %.","Press the cans in Live Status. +20% per click. Max. 200%.","Drücke die Dosen im Live-Status. +20 % pro Klick. Max. 200 %.","Naciśnij puszki w statusie na żywo. +20% za kliknięcie. Maks. 200%."],
["Klik for Pepsi Max Boost","Click for Pepsi Max Boost","Für Pepsi-Max-Boost klicken","Kliknij, aby doładować Pepsi Max"],
["Alt ser mistænkeligt professionelt ud.","Everything looks suspiciously professional.","Alles sieht verdächtig professionell aus.","Wszystko wygląda podejrzanie profesjonalnie."],
["ØGET ARBEJDSLYST","INCREASED MOTIVATION","MEHR ARBEITSLUST","WIĘKSZA CHĘĆ DO PRACY"],
["Produktiviteten er steget. Ingen ved hvorfor.","Productivity is up. Nobody knows why.","Die Produktivität steigt. Niemand weiß warum.","Produktywność wzrosła. Nikt nie wie dlaczego."],
["TVIVLSOMT HØJT TEMPO","QUESTIONABLY HIGH PACE","FRAGWÜRDIG HOHES TEMPO","PODEJRZANIE WYSOKIE TEMPO"],
["Gravemaskinen virker pludselig større.","The excavator suddenly seems bigger.","Der Bagger wirkt plötzlich größer.","Koparka nagle wydaje się większa."],
["Planlægningen er officielt blevet sprunget over.","Planning has officially been skipped.","Die Planung wurde offiziell übersprungen.","Planowanie zostało oficjalnie pominięte."],
["⚠ OVERTRYK","⚠ OVERPRESSURE","⚠ ÜBERDRUCK","⚠ NADCIŚNIENIE"],
["Arbejdshastighed +40 %. Dømmekraft -63 %.","Work speed +40%. Judgement -63%.","Arbeitstempo +40 %. Urteilsvermögen -63 %.","Tempo pracy +40%. Rozsądek -63%."],
["🚨 KRITISK ENTREPRENØRTILSTAND","🚨 CRITICAL CONTRACTOR CONDITION","🚨 KRITISCHER BAUUNTERNEHMERZUSTAND","🚨 KRYTYCZNY STAN WYKONAWCY"],
["STOP MED AT GIVE DEM PEPSI MAX.","STOP GIVING THEM PEPSI MAX.","GEBT IHNEN KEIN PEPSI MAX MEHR.","PRZESTAŃCIE DAWAĆ IM PEPSI MAX."]
  );
